...
$$a(r) \cdot dt(r) = c \cdot e^{-\frac{\mathbf{E}}{F_{max}\cdot r}} \cdot \frac{\mathbf{E}}{F_{max}\cdot r^2} \cdot \frac{dr}{c} = \underbrace{\frac{c^2\cdot \mathbf{E}}{F_{max}\cdot r^2}}_{a(r)} \cdot \underbrace{e^{-\frac{\mathbf{E}}{F_{max}\cdot r}}\cdot dt}_{d\tau(r)}$$
